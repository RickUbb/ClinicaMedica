...
public class DoctorController {
    ...
    @GetMapping("/search-appointment/{doctoId}")
    public ResponseEntity<?> findAppointmentByDoctorId(@PathVariable Long doctoIdId) {
        return ResponseEntity.ok(doctorService.findAppointmentsByDoctorId(doctoIdId));
    }
